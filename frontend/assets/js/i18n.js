...
// --- AUTH (Bejelentkezés) ---
    ...
    ru: { highScore: "Рекорд:", pts: "очков", streakMode: "🔥 Режим Стрик (Выживание)", btnHungary: "ВЕНГРИЯ", btnWorld: "ВЕСЬ МИР", btnEurope: "ЕВРОПА", btnAmerica: "АМЕРИКА", btnAsia: "АЗИЯ", btnAfrica: "AFRIKA", loading: "Загрузка...", mode: "Режим:", score: "Счёт:", time: "Время:", round: "Раунд:", streakLabel: "Стрик:", guessBtn: "УГАДАТЬ", roundEnd: "Конец раунда", dist: "Дистанция:", nextBtn: "ДАЛЕЕ", gameOverBtn: "ИТОГИ", streakAlive: "✅ Стрик жив!", streakLost: "❌ Стрик потерян!", max: "Макс:", gameOverTitle: "Конец игры", totalScore: "Всего:", achievedStreak: "Стрик:", newRecord: "(Рекорд! 🎉)", backMenu: "В МЕНЮ", compassN: "С", modes: { WORLD: "🌍 Мир", HUNGARY: "🇭🇺 Венгрия", EUROPE: "🇪🇺 Европа", AMERICA: "🇺🇸 Америка", ASIA: "🌏 Азия", AFRICA: "🌍 Африка" }, realLoc: "Тут", guessLoc: "Твой выбор" },
    zh: { highScore: "最高分:", pts: "分", streakMode: "🔥 连胜模式 (生存)", btnHungary: "匈牙利", btnWorld: "全世界", btnEurope: "欧洲", btnAmerica: "美洲", btnAsia: "亚洲", btnAfrica: "非洲", loading: "加载中...", mode: "模式:", score: "分数:", time: "时间:", round: "回合:", streakLabel: "连胜:", guessBtn: "提交", roundEnd: "回合结束", dist: "距离:", nextBtn: "下一轮", gameOverBtn: "游戏结束", streakAlive: "✅ 连胜继续!", streakLost: "❌ 连胜中断!", max: "最高:", gameOverTitle: "游戏结束", totalScore: "总分:", achievedStreak: "连胜:", newRecord: "(新纪录! 🎉)", backMenu: "返回主菜单", compassN: "北", modes: { WORLD: "🌍 全世界", HUNGARY: "🇭🇺 匈牙利", EUROPE: "🇪🇺 欧洲", AMERICA: "🇺🇸 美洲", ASIA: "🌏 亚洲", AFRICA: "🌍 非洲" }, realLoc: "真实", guessLoc: "预测" },
    pt: { highScore: "Melhor Pontuação:", pts: "pts", streakMode: "🔥 Modo Streak (Sobrevivência)", btnHungary: "HUNGRIA", btnWorld: "MUNDO", btnEurope: "EUROPA", btnAmerica: "AMÉRICA", btnAsia: "ÁSIA", btnAfrica: "ÁFRICA", loading: "Carregando...", mode: "Modo:", score: "Pontos:", time: "Tempo:", round: "Rodada:", streakLabel: "Streak:", guessBtn: "ADIVINHAR", roundEnd: "Fim da rodada", dist: "Distância:", nextBtn: "PRÓXIMO", gameOverBtn: "FIM DO JOGO", streakAlive: "✅ Streak vivo!", streakLost: "❌ Streak perdido!", max: "Máx:", gameOverTitle: "Fim do Jogo", totalScore: "Total:", achievedStreak: "Streak:", newRecord: "(Recorde! 🎉)", backMenu: "VOLTAR", compassN: "N", modes: { WORLD: "🌍 Mundo", HUNGARY: "🇭🇺 Hungria", EUROPE: "🇪🇺 Europa", AMERICA: "🇺🇸 América", ASIA: "🌏 Ásia", AFRICA: "🌍 África" }, realLoc: "Real", guessLoc: "Tipp" },
    it: { highScore: "Miglior punteggio:", pts: "pt", streakMode: "🔥 Modalità Streak (Sopravvivenza)", btnHungary: "UNGHERIA", btnWorld: "MONDO", btnEurope: "EUROPA", btnAmerica: "AMERICA", btnAsia: "ASIA", btnAfrica: "AFRICA", loading: "Caricamento...", mode: "Modo:", score: "Punti:", time: "Tempo:", round: "Round:", streakLabel: "Streak:", guessBtn: "INDOVINA", roundEnd: "Fine round", dist: "Distanza:", nextBtn: "PROSSIMO", gameOverBtn: "FINE GIOCO", streakAlive: "✅ Streak continua!", streakLost: "❌ Streak persa!", max: "Max:", gameOverTitle: "Fine Gioco", totalScore: "Totale:", achievedStreak: "Streak:", newRecord: "(Record! 🎉)", backMenu: "MENU", compassN: "N", modes: { WORLD: "🌍 Mondo", HUNGARY: "🇭🇺 Ungheria", EUROPE: "🇪🇺 Europa", AMERICA: "🇺🇸 America", ASIA: "🌏 Asia", AFRICA: "🌍 Africa" }, realLoc: "Reale", guessLoc: "Tipp" },
    ja: { highScore: "ハイスコア:", pts: "点", streakMode: "🔥 ストリークモード (生存)", btnHungary: "ハンガリー", btnWorld: "全世界", btnEurope: "ヨーロッパ", btnAmerica: "アメリカ", btnAsia: "アジア", btnAfrica: "アフリカ", loading: "読み込み中...", mode: "モード:", score: "スコア:", time: "時間:", round: "ラウンド:", streakLabel: "連勝:", guessBtn: "予測する", roundEnd: "ラウンド終了", dist: "距離:", nextBtn: "次へ", gameOverBtn: "ゲーム終了", streakAlive: "✅ 連勝中！", streakLost: "❌ 連勝ストップ！", max: "最大:", gameOverTitle: "ゲーム終了", totalScore: "合計:", achievedStreak: "連勝数:", newRecord: "(新記録! 🎉)", backMenu: "メニューに戻る", compassN: "北", modes: { WORLD: "🌍 世界", HUNGARY: "🇭🇺 ハンガリー", EUROPE: "🇪🇺 ヨーロッパ", AMERICA: "🇺🇸 アメリカ", ASIA: "🌏 アジア", AFRICA: "🌍 アフリカ" }, realLoc: "正解", guessLoc: "予測" }
};
